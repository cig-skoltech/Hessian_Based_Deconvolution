function [x,x_init,fun_val,ISNR]=deconvHessSDual(y,h,lambda,varargin)

%Image deconvolution with a Hessian Spectral Norm regularizer 
...
%               in ith iteration. {'fista'|'mfista'}  (Default: 'fista')
...
for i=1:iter
  ...
  [z,P,R,deniter,Lipconst]=denoiseHessSDual(b,lambda/L,'P',P,'R',...
    R,'tol',den_thr,'maxiter',den_iter,'optim',den_optim,'L',Lipconst,...
    'bounds',bounds,'bc',bc);
